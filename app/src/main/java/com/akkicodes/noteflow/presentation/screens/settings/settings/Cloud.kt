...
import com.akkicodes.noteflow.core.constant.DatabaseConst
...
import com.akkicodes.noteflow.presentation.screens.settings.TxtBackupHelper
                ...
                onPrimaryClick = {
                    if (webdavUrl.isBlank() || webdavUsername.isBlank() || webdavPassword.isBlank()) {
                        ...
                        coroutineScope.launch {
                            ...
                            workManager.enqueue(
                                OneTimeWorkRequestBuilder<com.akkicodes.noteflow.presentation.screens.settings.WebDAVBackupWorker>()
                                    .build()
                            )
                ...
                onSecondaryClick = {
                    if (webdavUrl.isBlank() || webdavUsername.isBlank() || webdavPassword.isBlank()) {
                        ...
                        coroutineScope.launch {
                            ...
                            workManager.enqueue(
                                OneTimeWorkRequestBuilder<com.akkicodes.noteflow.presentation.screens.settings.WebDAVRestoreWorker>()
                                    .build()
                            )
