...
val md_theme_dark_primary = Color(0xFF00C8A6)
val md_theme_dark_onPrimary = Color(0xFF003B32)
val md_theme_dark_primaryContainer = Color(0xFF005046)
val md_theme_dark_onPrimaryContainer = Color(0xFF00EED1)

val md_theme_dark_secondary = Color(0xFF4CE0C9)
val md_theme_dark_onSecondary = Color(0xFF003730)

val md_theme_dark_background = Color(0xFF0B1A18)
val md_theme_dark_onBackground = Color(0xFFE0F7F4)

val md_theme_dark_surface = Color(0xFF0F1E1C)
val md_theme_dark_onSurface = Color(0xFFCCF2EE)
