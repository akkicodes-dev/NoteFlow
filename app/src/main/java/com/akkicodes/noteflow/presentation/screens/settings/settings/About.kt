package com.akkicodes.noteflow.presentation.screens.settings.settings
...
import com.akkicodes.noteflow.presentation.screens.settings.SettingsScaffold
import com.akkicodes.noteflow.presentation.screens.settings.TitleText
import com.akkicodes.noteflow.presentation.screens.settings.loadState
import com.akkicodes.noteflow.presentation.screens.settings.model.SettingsViewModel
import com.akkicodes.noteflow.presentation.screens.settings.saveState
import com.akkicodes.noteflow.presentation.screens.settings.widgets.ActionType
import com.akkicodes.noteflow.presentation.screens.settings.widgets.ListDialog
import com.akkicodes.noteflow.presentation.screens.settings.widgets.SettingsBox

val appName = "NoteFlow"
val developer = "Developed by AkkiCodes"
val description = "A Simple and Modern Notes App built using Jetpack Compose."
        ...
        LazyColumn {
            item {
                SettingsBox(
                    ...
                    linkClicked = { uriHandler.openUri("https://f-droid.org/en/packages/com.akkicodes.noteflow/") }
                )
            }
            item {
                SettingsBox(
