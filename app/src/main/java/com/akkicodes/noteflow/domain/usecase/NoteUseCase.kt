package com.akkicodes.noteflow.domain.usecase
...
import com.akkicodes.noteflow.data.repository.NoteRepositoryImpl
import com.akkicodes.noteflow.domain.model.Note
import com.akkicodes.noteflow.presentation.components.DecryptionResult
import com.akkicodes.noteflow.presentation.components.EncryptionHelper
import com.akkicodes.noteflow.widget.NotesWidget
...
class NoteUseCase @Inject constructor(
    ...
    suspend fun batchUpdateNotes(notes: List<Note>) {
        ...
        Log.d("NoteUseCase", "Tags JSON: ${com.akkicodes.noteflow.data.local.database.Converters().fromStringList(notesToSave.firstOrNull()?.tags ?: emptyList())}")
